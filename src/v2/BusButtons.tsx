...
const buttonBase =
  "inline-block h-[31px] px-[12px] text-[14px] text-[#0f1111] rounded-[3px] border border-[#a2a6ac] border-t-[#adb1b8] border-b-[#8d9096] bg-gradient-to-b from-[#f7f8fa] to-[#e7e9ec] shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] cursor-pointer select-none whitespace-nowrap hover:border-[#979aa1] hover:border-t-[#a2a6ac] hover:border-b-[#82858a] focus:border-[#10b981] focus:shadow-[0_0_3px_2px_rgba(16,185,129,0.5)] focus:outline-none";
const buttonPressed =
  "font-bold text-[#111] !bg-gradient-to-b !from-[#6ee7b7] !to-[#34d399] !border-[#10b981] !border-t-[#34d399] !border-b-[#059669] shadow-[inset_0_1px_0_rgba(255,255,255,0.4),inset_0_-1px_2px_rgba(0,0,0,0.15)]";
