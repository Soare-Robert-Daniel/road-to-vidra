...
export function AutoButton({ programMode, className }: AutoButtonProps): JSX.Element {
  ...
  const inactiveClasses = "bg-white text-gray-600 shadow-sm hover:shadow-md hover:text-gray-900";

  return (
    <button
      class={twMerge(baseClasses, isAuto ? activeClasses : inactiveClasses, className)}
